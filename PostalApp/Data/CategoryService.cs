...
namespace PostalApp.Data
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<List<Category>> RefreshDataAsync()
        {
            ...
            var uri = new Uri("https://postalwebapi.azurewebsites.net/api/Categories");
        ...
        public async Task SaveTableItemAsync(Category item, bool isNewItem = false)
        {
            ...
            try
            {
                ...
                {
                    var uri = new Uri($"https://postalwebapi.azurewebsites.net/api/Categories/{item.Id}");
        ...
        public async Task DeleteTableItemAsync(string id)
        {
            ...
            var uri = new Uri($"https://postalwebapi.azurewebsites.net/api/Categories/{id}");
